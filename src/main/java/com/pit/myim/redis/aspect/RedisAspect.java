package com.pit.myim.redis.aspect;


import com.pit.myim.redis.annotation.RedisCache;
import com.pit.myim.redis.annotation.RedisEvict;
import com.pit.myim.redis.utils.RedisUtils;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.pit.myim.redis.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(com.pit.myim.redis.annotation.RedisEvict)")
